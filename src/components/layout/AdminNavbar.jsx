...
const AdminNavbar = () => {
  ...
  const navLinks = [
    ...
    { to: '/admin/supermarkets', label: 'Supermarkets', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-gradient-to-r from-gray-800 to-gray-900 shadow-lg z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/"
              target="_blank"
              className="hidden md:flex items-center gap-2 px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-gray-900 border-t border-gray-700 animate-slide-down">
